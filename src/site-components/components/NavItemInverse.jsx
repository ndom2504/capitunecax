...
export function NavItemInverse(
    {
    ...
    return <_Component className="nav-item inverse" button={false} block="inline" options={link}><_Builtin.Block className="nav-item-text" tag="div">{text}</_Builtin.Block><_Builtin.Block className="nav-item-line inverse" tag="div" /></_Component>;
}