...
export function ButtonPrimaryInverse(
    ...
    return (
        <_Component
            ...
            button={false}
            block="inline"
            options={link}><_Builtin.Block className="button-inner-text" tag="div">{text}</_Builtin.Block></_Component>
    );
}