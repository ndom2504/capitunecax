...
export function ButtonText(
    ...
    return <_Component className="button-text" button={false} block="inline" options={link}><_Builtin.Block className="button-text-inner" tag="div"><_Builtin.Block className="button-text-text" tag="div">{text}</_Builtin.Block><_Builtin.Block className="button-text-line" tag="div" /></_Builtin.Block></_Component>;
}