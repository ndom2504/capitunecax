    ...
    <div className="pt-24 pb-12 px-6 max-w-7xl mx-auto">
        ...
        <div className="bg-[#e87722]/10 border border-[#e87722]/20 p-6 rounded-3xl mb-12 flex flex-col md:flex-row items-center justify-between gap-6">
          <div className="flex items-center gap-4">
            ...
            <div>
              ...
              <p className="text-sm text-slate-600">Les Ã©coles sont filtrÃ©es selon vos objectifs d'Ã©tudes et compÃ©tences.</p>
            </div>
          </div>
        </div>
      ) : null}
      ...
      <div className="flex flex-col md:flex-row justify-between items-end gap-6 mb-12">
        ...
        <form onSubmit={handleRemoteSearch} className="flex gap-3 w-full md:w-auto">
          ...
          >
            ...
            <option value="QuÃ©bec" className="bg-white text-[#0a1628]">QuÃ©bec</option>
            ...
            <option value="Nouvelle-Ã‰cosse" className="bg-white text-[#0a1628]">Nouvelle-Ã‰cosse</option>
              ...
              <div key={inst.id} className="bg-white border border-slate-100 p-6 rounded-3xl hover:border-[#e87722]/30 transition-all group">
                <div className="flex justify-between items-start mb-6">
                  ...
                  <a 
                    ...
                    className="p-2 bg-slate-50 rounded-lg hover:bg-[#e87722] hover:text-black transition-all"
                  >
                ...
                <div className="mt-6 pt-6 border-t border-slate-100">
                  <a 
                    ...
                    target="_blank"
                    rel="noopener noreferrer"
                    className="block w-full py-3 rounded-xl bg-slate-50 border border-slate-100 text-[#0a1628] text-xs font-bold uppercase tracking-widest hover:bg-[#e87722] hover:text-black text-center transition-all"
                  >
                    Voir les programmes
                  </a>
                </div>
      ...
      {!loading && institutions.length === 0 && (
        <div className="text-center py-24 border-2 border-dashed border-slate-100 rounded-3xl text-gray-600">
          Aucun Ã©tablissement trouvÃ©. Essayez une autre recherche.
        </div>
      )}
    </div>
  );
